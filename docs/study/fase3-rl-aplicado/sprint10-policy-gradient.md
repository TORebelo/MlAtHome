...
### Sessão 1 — Derivação do Policy Gradient Theorem

Reference:    Sutton & Barto cap 13. Williams (1992) — REINFORCE original.
Build:        Derivação à mão em markdown.
Output:       notas/policy-gradient-derivation.md

### Sessão 2 — REINFORCE NumPy + PyTorch híbrido
...
### Sessão 3 — Variance reduction com baseline + GAE
...
### Sessão 6 — PPO — single-file production reference
...
### Sessão 7 — PPO clipping intuição
...
### Sessão 8 — Continuous control: PPO / SAC / DDPG / TD3
...
### Sessão 10 — Comparativo final

Build:        Tabela A2C vs PPO vs SAC vs DQN em 4 ambientes (CartPole, LunarLander, BipedalWalker, Pendulum). Métricas: episode reward médio últimos 100 episodes, samples para resolver, wall-clock.
Output:       09_comparativo.py
